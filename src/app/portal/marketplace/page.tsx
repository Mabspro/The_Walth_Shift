...
export default function Marketplace() {
  return (
    <div className="container mx-auto px-6">
      ...
      <div className="bg-white rounded-lg p-8 mb-12 border border-accent/20 shadow-lg">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-2/3">
            <h2 className="text-2xl font-bold mb-4 text-deep-sage">Featured Resource</h2>
            <h3 className="text-xl font-semibold mb-2 text-sage">Wealth Mindset Masterclass</h3>
            <p className="mb-4 text-portal-text-secondary font-medium leading-relaxed">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-1 text-portal-text-secondary font-medium">
          ...
          <div className="md:w-1/3 bg-gray-50 rounded-lg p-6 shadow-md">
            <h4 className="font-bold mb-2 text-deep-sage">Special Offer</h4>
            <p className="mb-1 text-sm text-portal-text-muted line-through">Regular price: $197</p>
      ...
      <h2 className="text-2xl font-bold mb-6 text-deep-sage">Digital Products</h2>
      ...
      <h2 className="text-2xl font-bold mb-6 text-deep-sage">Books & Guides</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <Card
      ...
      <h2 className="text-2xl font-bold mb-6 text-deep-sage">Services</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <Card
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-16 border border-accent/20">
        <h2 className="text-2xl font-bold mb-4 text-deep-sage">Our Curation Process</h2>
        <p className="mb-6 text-sage font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h3 className="text-lg font-semibold mb-2 text-deep-sage">Quality</h3>
            <p className="text-portal-text-secondary font-medium leading-relaxed">
              We personally review each resource to ensure it meets our high standards for quality and effectiveness.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2 text-deep-sage">Alignment</h3>
            <p className="text-portal-text-secondary font-medium leading-relaxed">
              We select resources that align with our holistic approach to wealth and support your overall journey.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2 text-deep-sage">Value</h3>
            <p className="text-portal-text-secondary font-medium leading-relaxed">
